...
Процедура Загрузить_ОтборПоСвойствамПланаОбмена(ДеревоОтборов, КорневойУзел)

	ТекущийУзелДереваПравил = ДобавитьНовуюСтрокуДереваПравил(КорневойУзел, "ОтборПоСвойствамПланаОбмена");
	
	Для Каждого СтрокаДерева Из ДеревоОтборов.Строки Цикл
		РекурсивноПрочитатьЭлементыИГруппыОтбораПоСвойствам(ТекущийУзелДереваПравил, СтрокаДерева);
	КонецЦикла;

КонецПроцедуры

Процедура Загрузить_ОтборПоСвойствамОбъекта(ДеревоОтборов, КорневойУзел)

	ТекущийУзелДереваПравил = ДобавитьНовуюСтрокуДереваПравил(КорневойУзел, "ОтборПоСвойствамОбъекта");
